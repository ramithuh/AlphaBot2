...
{
  ros::init(argc, argv, "teleop_alphabot2");
  TeleopAlphaBot teleop_alphabot2;

  signal(SIGINT,quit);

  teleop_alphabot2.keyLoop();
  quit(0);
...
void TeleopAlphaBot::keyLoop()
{
  ...
  puts("---------------------------");
  puts("Use arrow keys to move the AlphaBot2. 'q' to quit.");
